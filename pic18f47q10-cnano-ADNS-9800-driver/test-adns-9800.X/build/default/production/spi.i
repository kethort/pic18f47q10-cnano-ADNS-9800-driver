...
static __attribute__((inline)) uint8_t SPI_bitBangData(uint8_t u8DataToSendP)
{
    ...
    for (uint8_t u8BitNum=8; u8BitNum != 0; u8BitNum--)
    {
        ...
        (LATDbits.LATD6) = (u8DataToSendP & 0x80)? 1 : 0;
        u8DataToSendP <<= 1;
        u8ReceivedData <<= 1;
        u8ReceivedData |= ((PORTDbits.RD7) == 0)? 0x00 : 0x01;
