...
# 1 "./adns9800_srom_A4.h" 1




static const uint8_t ADNS_firmware_data[] =
{
0x03,
0xa4,
0x6e,
...
uint8_t ADNS_read_reg(uint8_t u8RegAddrP)
{
    ...
    __nop();
    ADNS_com_end();
    _delay((unsigned long)((19)*(4000000/4000000.0)));
...
void ADNS_write_reg(uint8_t u8RegAddrP, uint8_t u8DataP)
{
    ...
    (void)SPI_transfer(u8RegAddrP | 0x80);
...
void ADNS_upload_firmware(void)
{
    ...
    ADNS_com_begin();
    (void)SPI_transfer(0x62 | 0x80);
    _delay((unsigned long)((15)*(4000000/4000000.0)));

    for (uint16_t u16Idx = 0; u16Idx < 3070; u16Idx++)
    {
